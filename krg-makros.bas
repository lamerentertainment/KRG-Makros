...
Function SpezifischeFormatierungen(ByVal textstelle As String) As String
    ...
    'KRG Währungsformatierungen setzen
...
Private Function PronomenErsetzungMaennlich(textstelle As String) As String
    ...
    textstelle = Replace(textstelle, " unsere. ", " ihre. ")
    'unserer
    textstelle = Replace(textstelle, " unserer ", " ihrer ")
    textstelle = Replace(textstelle, " unserer, ", " ihrer, ")
    textstelle = Replace(textstelle, " unserer. ", " ihrer. ")
    'unseren
    textstelle = Replace(textstelle, " unseren ", " ihren ")
    textstelle = Replace(textstelle, " unseren, ", " ihren, ")
    textstelle = Replace(textstelle, " unseren. ", " ihren. ")
    'unserem
...
Private Function VerbenErsetzung(textstelle As String) As String
    ...
    textstelle = Replace(textstelle, " zieht.", " ziehe.")
    'Sie/er schreibt
    textstelle = Replace(textstelle, " schreibt ", " schreibe ")
    textstelle = Replace(textstelle, " schreibt,", " schreibe,")
    textstelle = Replace(textstelle, " schreibt.", " schreibe.")
    'Sie/er treibt
    textstelle = Replace(textstelle, " treibt ", " treibe ")
    textstelle = Replace(textstelle, " treibt,", " treibe,")
    textstelle = Replace(textstelle, " treibt.", " treibe.")
    'Sie/er sichert
    textstelle = Replace(textstelle, " sichert ", " sichere ")
    textstelle = Replace(textstelle, " sichert,", " sichere,")
    textstelle = Replace(textstelle, " sichert.", " sichere.")
    'Sie/er deckt
    textstelle = Replace(textstelle, " deckt ", " decke ")
    textstelle = Replace(textstelle, " deckt,", " decke,")
    textstelle = Replace(textstelle, " deckt.", " decke.")
    'Sie/er deckt
    textstelle = Replace(textstelle, " schädigt ", " schädige ")
    textstelle = Replace(textstelle, " schädigt,", " schädige,")
    textstelle = Replace(textstelle, " schädigt.", " schädige.")
    ...
    textstelle = Replace(textstelle, " brennt.", " brenne.")
    'es schmerzt
    textstelle = Replace(textstelle, " schmerzt ", " schmerze ")
    textstelle = Replace(textstelle, " schmerzt,", " schmerze,")
    textstelle = Replace(textstelle, " schmerzt.", " schmerze.")
    'es zeugt
...
Private Function VergangenheitsVerbenErsetzung(text As String)
    ...
    'Ich instruierte es -> er habe es instruiert.
    text = ersetzeVergangenheitsform(text, " instruierte ", " habe ", "instruiert")
    'Wir instruierten es. -> Sie hätten es instruiert.
    text = ersetzeVergangenheitsform(text, " instruierten ", " hätten ", "instruiert")
    'Ich schwamm runter. -> er sei runter geschwommen
    text = ersetzeVergangenheitsform(text, " schwamm ", " sei ", "geschwommen")
    'Wir schwammen runter. -> Sie seien runter geschwommen.
    text = ersetzeVergangenheitsform(text, " schwammen ", " seien ", "geschwommen")
    'Ich fällte es -> er habe es gefällt
    text = ersetzeVergangenheitsform(text, " fällte ", " habe ", "gefällt")
    'Wir fällten es. -> Sie hätten es gefällt.
    text = ersetzeVergangenheitsform(text, " fällten ", " hätten ", "gefällt")
    'Ich fasste den Plan. -> er habe den Plan gefasst
    text = ersetzeVergangenheitsform(text, " fasste ", " habe ", "gefasst")
    'Wir fassten den Plan. -> Sie hätten den Plan gefasst.
    text = ersetzeVergangenheitsform(text, " fassten ", " hätten ", "gefasst")
    'Ich schlug ihn. -> er habe diesen geschlagen
    text = ersetzeVergangenheitsform(text, " schlug ", " habe ", "geschlagen")
    'Wir schlugen vor. -> Sie hätten vorgeschlagen.
    text = ersetzeVergangenheitsform(text, " schlugen ", " hätten ", "geschlagen")
    'Ich verweigerte das. -> er habe das verweigert.
    text = ersetzeVergangenheitsform(text, " verweigerte ", " habe ", "verweigert")
    'Wir verweigerten es. -> Sie hätten es verweigert.
    text = ersetzeVergangenheitsform(text, " verweigerten ", " hätten ", "verweigert")
    'Ich schrie herum. -> er habe herum geschrien.
    text = ersetzeVergangenheitsform(text, " schrie ", " habe ", "geschrien")
    'Wir schrien ihn an. -> Sie hätten diesen angeschrien.
    text = ersetzeVergangenheitsform(text, " schrien ", " hätten ", "geschrien")
    'Ich packte ihn. -> er habe diesen gepackt.
    text = ersetzeVergangenheitsform(text, " packte ", " habe ", "gepackt")
    'Wir packten ein. -> Sie hätten ein gepackt.
    text = ersetzeVergangenheitsform(text, " packten ", " hätten ", "gepackt")
    'Ich verzichtete darauf. -> er habe darauf verzichtet.
    text = ersetzeVergangenheitsform(text, " verzichtete ", " habe ", "verzichtet")
    'Wir verzichteten dankend. -> Sie hätten dankend verzichtet.
    text = ersetzeVergangenheitsform(text, " verzichteten ", " hätten ", "verzichtet")
    'Ich rannte davon. -> er sei davon gerannt.
    text = ersetzeVergangenheitsform(text, " rannte ", " sei ", "gerannt")
    'Wir rannten schnell. -> Sie seien schnell gerannt.
    text = ersetzeVergangenheitsform(text, " rannten ", " seien ", "gerannt")
    'Ich versteckte mich. -> er habe sich versteckt.
    text = ersetzeVergangenheitsform(text, " versteckte ", " habe ", "versteckt")
    'Wir versteckten es. -> Sie hätten es versteckt.
    text = ersetzeVergangenheitsform(text, " versteckten ", " hätten ", "versteckt")
    'Ich übte es. -> er habe es geübt.
    text = ersetzeVergangenheitsform(text, " übte ", " habe ", "geübt")
    'Wir übten es. -> Sie hätten es geübt.
    text = ersetzeVergangenheitsform(text, " übten ", " hätten ", "geübt")
    'Ich aquirierte viel. -> er habe viel aquiriert.
    text = ersetzeVergangenheitsform(text, " aquirierte ", " habe ", "aquiriert")
    'Wir aquirierten es. -> Sie hätten es aquiriert.
    text = ersetzeVergangenheitsform(text, " aquirierten ", " hätten ", "aquiriert")
    'Ich autorisierte es. -> er habe es autorisiert.
    text = ersetzeVergangenheitsform(text, " autorisierte ", " habe ", "autorisiert")
    'Wir autorisierten es. -> Sie hätten es autorisiert.
    text = ersetzeVergangenheitsform(text, " autorisierten ", " hätten ", "autorisiert")
    'Ich behielt es. -> er habe es behalten.
    text = ersetzeVergangenheitsform(text, " behielt ", " habe ", "behalten")
    'Wir behielten es. -> Sie hätten es behalten.
    text = ersetzeVergangenheitsform(text, " behielten ", " hätten ", "behalten")
    'Ich identifizierte es. -> er habe es identifiziert.
    text = ersetzeVergangenheitsform(text, " identifizierte ", " habe ", "identifiziert")
    'Wir identifizierten es. -> Sie hätten es identifiziert.
    text = ersetzeVergangenheitsform(text, " identifizierten ", " hätten ", "identifiziert")
    'Ich deckte es. -> er habe es gedeckt.
...
Function VerbenZusammenfuegen(text As String)
    ...
    text = VerbenZusammenfuegung(text, "ab gelegt", "abgelegt")
    text = VerbenZusammenfuegung(text, "zu gekommen", "zugekommen")
    text = VerbenZusammenfuegung(text, "herein geholt", "hereingeholt")
    text = VerbenZusammenfuegung(text, "ab gegeben", "abgegeben")
    text = VerbenZusammenfuegung(text, "aus gereicht", "ausgereicht")
    text = VerbenZusammenfuegung(text, "vor geschlagen", "vorgeschlagen")
    text = VerbenZusammenfuegung(text, "ein geschlagen", "eingeschlagen")
    text = VerbenZusammenfuegung(text, "auf gestanden", "aufgestanden")
    text = VerbenZusammenfuegung(text, "ab geholt", "abgeholt")
    text = VerbenZusammenfuegung(text, "an geschrien", "angeschrien")
    text = VerbenZusammenfuegung(text, "herum geschrien", "herumgeschrien")
    text = VerbenZusammenfuegung(text, "ein gepackt", "eingepackt")
    text = VerbenZusammenfuegung(text, "aus gepackt", "ausgepackt")
